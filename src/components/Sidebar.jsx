      ...
      {activeMenu && (<>
        <div className='flex justify-between items-center'>
          ...
          <TooltipComponent content='Menu' position='BottomCenter'>
            <button type='button' onClick={() => setActiveMenu(!activeMenu)} className='text-xl rounded-full p-3 hover:bg-light-gray mt-4 block'> {/* there should be a md:hidden in className */}
              <MdOutlineCancel />
            </button>
          </TooltipComponent>
        </div>
